...
namespace LostMind.Engine.Native {
    ...
    #endregion
    #region SafeFileMapViewHandle
    [HostProtectionAttribute(MayLeakOnAbort = true)]
    [SuppressUnmanagedCodeSecurityAttribute]
    public sealed class SafeFileMapViewHandle : SafeHandleZeroOrMinusOneIsInvalid {
        // Note that MapViewOfFile returns 0 on failure

        public SafeFileMapViewHandle() : base(true) { }

        [DllImport(ExternDll.Kernel32, ExactSpelling = true, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.Machine)]
        public static extern SafeFileMapViewHandle MapViewOfFile(SafeFileMappingHandle hFileMappingObject, int dwDesiredAccess, int dwFileOffsetHigh, int dwFileOffsetLow, UIntPtr dwNumberOfBytesToMap);
    ...
    public static class NativeMethods {
        ...
        public static uint SetNamedSecurityInfo(
            string directory,
            SafeLocalMemHandle pDacl) {
            // 1 - se_file_object
        ...
        public static void CreateDirectory(string path, SafeLocalMemHandle acl) {
        ...
        public const int FABORTONOERROR = 14;
        public const int FDUMMY2 = 15;

        public const int PURGE_TXABORT = 0x0001;  // Kill the pending/current writes to the comm port.
        public const int PURGE_RXABORT = 0x0002;  // Kill the pending/current reads to the comm port.
        public const int PURGE_TXCLEAR = 0x0004;  // Kill the transmit queue if there.
        public const int PURGE_RXCLEAR = 0x0008;  // Kill the typeahead buffer if there.
        ...
        public const int EV_RXCHAR = 0x01;
        public const int EV_RXFLAG = 0x02;
        public const int EV_CTS = 0x08;
        ...
        public const int ALL_EVENTS = 0x1fb;  // don't use EV_TXEMPTY
        ...
        public const int MAXDWORD = -1;   // note this is 0xfffffff, or UInt32.MaxValue, here used as an int
        ...
        [StructLayout(LayoutKind.Sequential)]
        public class PERF_COUNTER_BLOCK {
            public int ByteLength = 0;
        }

        [StructLayout(LayoutKind.Sequential)]
        public class PERF_COUNTER_DEFINITION {
            public int ByteLength = 0;
        ...
        [ResourceExposure(ResourceScope.Machine)]
        public static extern SafeFileMappingHandle CreateFileMapping(IntPtr hFile, NativeMethods.SECURITY_ATTRIBUTES lpFileMappingAttributes, int flProtect, int dwMaximumSizeHigh, int dwMaximumSizeLow, string lpName);

        [DllImport(ExternDll.Kernel32, CharSet = CharSet.Auto, SetLastError = true, BestFitMapping = false)]
        [ResourceExposure(ResourceScope.Machine)]
        public static extern SafeFileMappingHandle OpenFileMapping(int dwDesiredAccess, bool bInheritHandle, string lpName);
        ...
        */
        ...
        [DllImport(ExternDll.Kernel32, SetLastError = true)]
        [ResourceExposure(ResourceScope.None)]
        unsafe public static extern IntPtr VirtualQuery(SafeFileMapViewHandle address, ref MEMORY_BASIC_INFORMATION buffer, IntPtr sizeOfBuffer);
    ...
    public static class SafeNativeMethods {
        ...
        */
        ...
        [ResourceExposure(ResourceScope.Machine)]
        public static extern SafeWaitHandle CreateSemaphore(NativeMethods.SECURITY_ATTRIBUTES lpSecurityAttributes, int initialCount, int maximumCount, String name);
        ...
        [DllImport(ExternDll.Kernel32, SetLastError = true, CharSet = CharSet.Auto, BestFitMapping = false)]
        [ResourceExposure(ResourceScope.Machine)]
        public static extern SafeWaitHandle OpenSemaphore(/* DWORD */ int desiredAccess, bool inheritHandle, String name);
